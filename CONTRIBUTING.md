...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/decorator-regex
   cd decorator-regex
   ```
...
```sh
https://github.com/flex-development/decorator-regex/compare/main...$branch
```
...
[19]: https://github.com/flex-development/decorator-regex/discussions/new?category=q-a
